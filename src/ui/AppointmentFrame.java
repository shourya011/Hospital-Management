...
/**
 * AppointmentFrame - Opens Appointment panel in a separate window
 */
public class AppointmentFrame extends JFrame {
    ...
    public AppointmentFrame(AppointmentDAO appointmentDAO, PatientDAO patientDAO) {
        ...
        JPanel contentPanel = new AppointmentPanel(appointmentDAO, patientDAO);
